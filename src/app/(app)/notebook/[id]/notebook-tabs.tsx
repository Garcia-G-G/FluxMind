...
/**
 * Client island for the notebook layout — owns tab-active state, source-panel
 * open/close, and the collapsible sources sidebar. The wrapping layout is an
 * RSC so the shell can stream tab content via <Suspense>.
 */
export const NotebookTabs = ({
  ...
  const basePath = `/notebook/${notebookId}`;
