...
// Opt out of prerender — the (app) layout is already dynamic via auth, and
// Next 15 otherwise tries to SSG this client shell and fails in webpack
// chunk resolution.
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mt-5 pt-3" style={{ borderTop: "1px solid var(--fm-surface-border)" }}>
                      <span className="text-[11px]" style={{ color: "var(--fm-text-tertiary)" }} suppressHydrationWarning>
                        {nowMs ? formatRelativeTime(notebook.updatedAt, nowMs) : "\u00A0"}
                      </span>
                      <ChevronRight
